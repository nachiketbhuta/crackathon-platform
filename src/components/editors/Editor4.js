...
export default class Editor4 extends Component {
  ...
  async componentWillMount() {
    ...
    // Language
    const randomLang = this.state.languages[3];
    ...
    this.setState({
      isSubmitted: localStorage.getItem('prgm4') === 'true' ? true: false,
  ...
  renderScore = (isCorrect) => {
    ...
    if (isCorrect) {
      ...
      score += 100
      localStorage.setItem('prgm4', true);
      ...
      score -= 10;
      localStorage.setItem('prgm4', false);
    }
